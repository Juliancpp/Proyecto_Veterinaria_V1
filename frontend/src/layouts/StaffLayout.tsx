...
import { PawPrint, FileText, LogOut, Heart, HeartHandshake } from "lucide-react";
...
const staffLinks = [
  { to: "/staff/pets", label: "Mascotas", icon: PawPrint },
  { to: "/staff/adoptions", label: "Adopciones", icon: HeartHandshake },
  { to: "/staff/reports", label: "Reportes", icon: FileText },
];
      ...
      <div className="flex min-h-screen w-full">
        ...
        <div className="flex flex-1 flex-col">
          <header className="flex h-14 items-center border-b border-border/50 bg-background/80 px-4 backdrop-blur-sm">
            <SidebarTrigger />
            <span className="ml-3 text-sm font-medium text-muted-foreground">Panel de Staff</span>
          </header>
